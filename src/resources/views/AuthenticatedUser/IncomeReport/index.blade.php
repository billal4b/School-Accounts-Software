				...
				<div class="form-group form-group-sm">		
					...
					<div class="col-sm-4">
						<select id="head_name" name="head_name" class="form-control">
                                <option value="">----- Select -----</option>
                                <?php
                                $heads = DB::table('tbl_received_student_payment_sub_heads')
                                        ->select('student_payment_id', 'student_payment_name')
                                        //->where('is_active', 1)
                                        ->groupBy('student_payment_id')
                                        ->get();
                                foreach($heads as $h){
                                    echo '<option value="' . $h->student_payment_id . '">' . $h->student_payment_name . '</option>';
                                }
                                ?>
...
<!--					<label for="sub_head_name" class="col-sm-2 control-label">Total Head</label>
					<div class="col-sm-4">
					    <select id="sub_head_name" name="sub_head_name" class="form-control">
                               <option value="">--- Select ---</option>
                               ...
                               <option value="T.C Fees">T.C Fees</option>
