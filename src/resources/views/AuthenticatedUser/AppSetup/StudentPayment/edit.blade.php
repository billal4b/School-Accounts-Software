                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('studentPayment.update', array('id' => $data['stdPaymentDetails']->student_payment_id))) }}">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="radio">
                                <label>
                                    <input name="branch_and_version" type="radio" value="{{ $si->institute_branch_version_id }}" {{ $si->institute_branch_version_id == $data['stdPaymentDetails']->institute_branch_version_id ? 'checked' : '' }}>
