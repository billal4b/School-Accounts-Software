...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Third Party Create </strong></div>
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('thirdParty.store')) }}">
                    ...
                    <div class="form-group form-group-sm">
					 ...
					 <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="third_party_details" name="third_party_details" placeholder="Details" value="{{ old('third_party_details') }}">
                        </div>
					 ...
					 <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="third_party_address" name="third_party_address" placeholder="Address" value="{{ old('third_party_address') }}">
                        </div>
					 ...
					 <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="third_party_category" name="third_party_category" placeholder="Category" value="{{ old('third_party_category') }}">
                        </div>
