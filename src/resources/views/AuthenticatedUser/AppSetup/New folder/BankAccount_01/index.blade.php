        ...
        <div class="panel panel-default">
            ...
            <table class="table table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    @foreach($data['bankAccountList'] as $egl)
                    <tr>
                        <td>{{ $egl->account_id }}</td>
                        ...
                        <td><a class="btn btn-primary btn-sm" href="{{ url(route('bankAccount.edit', array('id' => $egl->account_id))) }}"><i class="fa fa-pencil-square-o"></i>&nbsp;Update</a></td>
                    </tr>
                    @endforeach
                    @endif
                </tbody>
