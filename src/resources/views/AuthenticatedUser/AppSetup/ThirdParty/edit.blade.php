...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Update Third Party Details</strong></div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('thirdParty.update', array('id' => $data['thirdPartyDetails']->third_party_id))) }}">
                    ...
                    <div class="form-group form-group-sm">
					 ...
					 <div class="form-group form-group-sm">
                        <label for="third_party_contact" class="col-sm-2 control-label">Contact<sup><i class="fa fa-asterisk"></i></sup></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="third_party_contact" name="third_party_contact" placeholder="Third Party Contact" value="{{ $data['thirdPartyDetails']->third_party_contact }}">
                        </div>
					 ...
					 <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="third_party_open_balance" name="third_party_open_balance" placeholder="Third Party Opening Balance" value="{{ $data['thirdPartyDetails']->third_party_open_balance }}">
                        </div>
                    ...
                    <div class="form-group form-group-sm">
                        <label for="third_party_status" class="col-sm-2 control-label">Status<sup><i class="fa fa-asterisk"></i></sup></label>
                        <div class="col-sm-6">
