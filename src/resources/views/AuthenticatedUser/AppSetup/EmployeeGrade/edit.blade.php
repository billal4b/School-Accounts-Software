...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Update Employee Grade Details  </strong></div>
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('empGrade.update', array('id' => $data['empGradeDetails']->grade_id))) }}">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="radio">
                                <label>
                                    <input name="branch_and_version" type="radio" value="{{ $si->institute_branch_version_id }}" {{ $si->institute_branch_version_id == $data['empGradeDetails']->institute_branch_version_id ? 'checked' : '' }}>
