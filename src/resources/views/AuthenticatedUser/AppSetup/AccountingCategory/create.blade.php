...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Account Category Details </strong></div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('accountCategory.store')) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="account_category_name" name="account_category_name" placeholder="Account Category Name" value="{{ old('account_category_name') }}">
                        </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="account_category_status">
