...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Update Bank Branch Details </strong></div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('branch.update', array('id' => $data['branchDetails']->branch_id))) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="branch_name" name="branch_name" placeholder="Branch Name" value="{{ $data['branchDetails']->branch_name }}">
                        </div>
                        ...
                        <div class="col-sm-6">
                            <select id="bank_name" name="bank_name" class="form-control">
							 ...
							 <script type="text/javascript">
                                document.getElementById('bank_name').value = '{{ $data['branchDetails']->bank_id }}';
                            </script>
                        </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            ...
                            <script type="text/javascript">
                                document.getElementById('branch_status').value = '{{ $data['branchDetails']->is_active }}';
                            </script>
                        </div>
