...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><strong>Update Sub Head Details</strong></div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url(route('subHead.update', array('id' => $data['subHeadDetails']->sub_head_id))) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="sub_head_name" name="sub_head_name" placeholder="Sub Head Name" value="{{ $data['subHeadDetails']->sub_head_name }}">
                        </div>
					...
					<div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
							...
							<script type="text/javascript">
                                document.getElementById('accounting_category').value = '{{ $data['subHeadDetails']->account_category_id }}';
                            </script>
                        </div>
					...
					<div class="form-group form-group-sm">
                        <label for="head_name" class="col-sm-2 control-label">Head Account Name<sup><i class="fa fa-asterisk"></i></sup></label>
                        <div class="col-sm-6">
                            <select id="head_name" name="head_name" class="form-control">
                                <option value="">----- Select -----</option>
                                @if(isset($data['heads']))
                                @foreach($data['heads'] as $hds)
                                <option value="{{ $hds->head_id }}">{{ $hds->head_name }}</option>
                                @endforeach
							    @endif      
                            </select>
							<script type="text/javascript">
                                document.getElementById('head_name').value = '{{ $data['subHeadDetails']->head_id }}';
                            </script>
                        </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="sub_head_status" id="sub_head_status">
                                <option value="">----- Select -----</option>
                            ...
                            <script type="text/javascript">
                                document.getElementById('sub_head_status').value = '{{ $data['subHeadDetails']->is_active }}';
                            </script>
                        </div>
