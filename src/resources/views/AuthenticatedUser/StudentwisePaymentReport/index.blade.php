...
<div class="row">
    <div class="col-sm-12">
	    <div class="panel panel-default">
            <div class="panel-heading"><strong> Student wise Payment Report</strong></div>
            ...
            <div class="panel-body">
				...
				<label for="search_value" class="col-sm-2 control-label"> Search in Student ID</label>
				  <div class="col-sm-4">
				    
		            <input type="search"  class="form-control" id='search_value' name="search_value" placeholder="Search in Student ID"/>							   
