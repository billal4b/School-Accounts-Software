        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				action="{{ url(route('3in1p', array('id'=>$data['pageType']))) }}">
                    ...
                    <div class="form-group form-group-sm">
					    <label for="check_amount" class="col-sm-2 control-label">Check Amount <sup><i class="fa fa-asterisk"></i> </sup></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="check_amount" name="check_amount" placeholder=" Check Amount "/>
                        </div>
