...
//				if(empty($request->sub_head_name)){
//					$sub_head_name = null;
//				}else{
...
//					
//				$this->data['totalIncomeReport'] = DB::select('call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00",
//				"' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'",
//				"'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'"/*,"'.$sub_head_name.'"*/,
//				"'.Auth::user()->user_id.'")');				
//				
//				}else{
//					
//					$this->data['totalIncomeReport'] = DB::select('call income_report_head("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00",
//				"' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$sub_head_name.'","'.Auth::user()->user_id.'")');	
//					
//				}
...
//				"'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'"/*,"'.$sub_head_name.'"*/,
//				"'.Auth::user()->user_id.'")');
                                $this->data['totalIncomeReport'] = DB::select('call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00", "' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'", "'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'","'.Auth::user()->user_id.'")');
				
				
				
//          echo 'call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00","' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'","'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'","'.Auth::user()->user_id.'")';exit();
				//$this->data['totalIncomeReport'] = DB::select('call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00","' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'","'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'","'.Auth::user()->user_id.'")');				
...
//			if($request->sub_head_name == null){
//						
//				$this->data['IncomeReportPrint'] = DB::select('call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00",
//				      "' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'",
//					  "'.$class_name.'","'.$section_name.'","'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'","'.$sub_head_name.'","'.Auth::user()->user_id.'")');		
//				
//			}else{
//					
//					$this->data['IncomeReportPrint'] = DB::select('call income_report_head("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00",
//				"' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$sub_head_name.'","'.Auth::user()->user_id.'")');	
//					
//			}	
				
				
				$this->data['IncomeReportPrint'] = DB::select('call income_report("' . date('Y-m-d', strtotime(str_replace('-', '-', $request->from_date))) . ' 00:00:00", "' . date('Y-m-d', strtotime(str_replace('-', '-', $request->to_date))) . ' 23:59:59","'.$branch_and_version.'", "'.$class_name.'","'.$section_name.'", "'.$group_name.'","'.$student_id.'", "'.$head_name.'", "'.$bank_name.'","'.Auth::user()->user_id.'")');
